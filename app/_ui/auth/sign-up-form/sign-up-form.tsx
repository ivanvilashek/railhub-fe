...
import { useSignUp } from '@app/lib/queries/auth'
...
export const SignUpForm: React.FC = () => {
  ...
  const onSubmit: SubmitHandler<z.output<typeof SignUpSchema>> = useCallback(
    async (data) => {
      try {
    ...
    <div className="w-full max-w-lg rounded-3xl bg-gray-2 p-4">
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-1 flex-col gap-y-6 rounded-2xl bg-white p-6 shadow-[0_24px_36px_0_#7B61FF14]">
          <p className="text-2xl font-medium text-gray-8">Create new account</p>
